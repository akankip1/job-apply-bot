...
const RULES = [
  ...
  // --- Experience range radios (each option is a separate radio, return "" for non-matching) ---
  { label: /years of experience/i, key: "yearsOfExperience", source: (p, ans, field) => {
  ...
  { label: /demographic data.*consent|consent.*demographic data/, key: "demographicDataConsent", source: (p, ans) => ans.demographic_data_consent },
  ...
  { label: /retain my data|future opportunities/, key: "retentionConsent", source: (p, ans) => ans.retention_consent },
